...
function Lagrange() {
  ...
  const handleSubmit=(e)=>{
        ...
        if (row==4){
            ...
            matb[3] =parseFloat(b4Ref.current.value)
             // for (let i = 0; i <row; i++) {
        ...
        if (row==5){
            ...
            matb[2] =parseFloat(b3Ref.current.value)
            matb[3] =parseFloat(b4Ref.current.value)
            matb[4] =parseFloat(b5Ref.current.value)
             // for (let i = 0; i <row; i++) {
            //     console.log(matrix[i]);
            //     console.log(matb[i]);
            // }
        ...
        if (row==6){
            ...
            matb[3] =parseFloat(b4Ref.current.value)
            matb[4] =parseFloat(b5Ref.current.value)
            matb[5] =parseFloat(b6Ref.current.value)
            // for (let i = 0; i <row; i++) {
            //     console.log(matrix[i]);
            //     console.log(matb[i]);
            // }
        ...
        for (let i = 0; i < n; i++)
        {
            ...
            {
                if (j !== i)
                    term = term*(v - matrix[j]) / (matrix[i] - matrix[j]);
            }
            sum += term;
        }
